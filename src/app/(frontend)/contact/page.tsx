        ...
        <Container>
          <div className="grid gap-16 lg:grid-cols-2">
            ...
            <div className="space-y-10">
              {/* Contact info */}
              <div>
                <h2 className="mb-6 font-serif text-2xl font-bold text-gray-900">Get in Touch</h2>
              ...
              {hours && hours.length > 0 && (
                <div>
                  ...
                  <dl className="divide-y divide-gray-100 overflow-hidden rounded-card ring-1 ring-gray-100">
                    {hours.map((h, i) => (
            ...
            {/* Right — form */}
            <div>
              <h2 className="mb-6 font-serif text-2xl font-bold text-gray-900">Send a Message</h2>
              <ContactForm />
            </div>
          </div>
        </Container>
